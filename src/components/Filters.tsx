...
function Filters() {
	const { filters, changeMinPrice, changeCategory, changeOrder } = useFilters();
	...
	return (
		<section className='flex w-full flex-col items-center justify-center gap-10 md:flex-row'>
